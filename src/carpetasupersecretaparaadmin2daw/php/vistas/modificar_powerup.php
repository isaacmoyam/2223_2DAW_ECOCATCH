<main id="gestor">
    ...
    <form enctype="multipart/form-data" action="index.php?control=powerup_con&metodo=modificar&id=<?php echo $fila['id'];?>" method="POST" id="formPowerup">
        <label>(*) Nombre:</label>
        <input type="text" name="nombre" value="<?php echo $fila['nombre'];?>" placeholder="Nombre Powerup" maxlength="20">
        <label>(*) Aumento:</label>
        <input type="text" name="aumento" value="<?php echo $fila['aumento'];?>" placeholder="Aumento">
        <label>(*) Imagen:</label>
        <input type="file" name="imagen">
        <label>Descripción:</label>
        <input type="text" name="descripcion" value="<?php echo $fila['descripcion'];?>" maxlength="300">
